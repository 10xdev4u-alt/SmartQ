...
//
// The application runs readPump in a goroutine for each client connection. The
...
func (c *Client) readPump() {
	...
	for {
		...
		// For now, we don't expect clients to send messages, but if they did,
...
//
// A goroutine running writePump is started for each client connection. The
